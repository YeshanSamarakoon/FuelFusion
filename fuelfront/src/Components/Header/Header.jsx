        ...
        <div className='flexCenter gap-x-4'>
          ...
          <div>
            <Navbar containerStyles={`${menuOpened ? 
              "flex item-start flex-col gap-y-12 fixed top-20 right-8 p-12 bg-white rounded-3xl shadow-md w-64 medium-20 ring-1 ring-slate-900/5 transition-all duration-500 z-50" 
            : "hidden item-start flex-col gap-y-12 fixed top-20 right-8 p-12 bg-white rounded-3xl shadow-md w-64 medium-20 ring-1 ring-slate-900/5 transition-all duration-500 z-50 -right-[100%]"
                }`} />
          </div>
          ...
          <div className='flexBetween gap-x-3 sm:gap-x-2 bold-16'>
                ...
                <div className='flexBetween sm:gap-x-0'>
                  <NavLink to={'/'} className={'flex'}>
                      <RiShoppingCart2Line className='p-2 h-10 w-10 hover:text-secondary duration-500'/>
